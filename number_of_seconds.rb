...
puts "That means when you turn 20, you've been alive for #{seconds_in_minute * minutes_in_hour * hours_in_day * days_in_week * weeks_in_year * 20} seconds,"
puts "and if you make it to 100, you will have lived #{seconds_in_minute * minutes_in_hour * hours_in_day * days_in_week * weeks_in_year * 100} seconds. Make them count!"
